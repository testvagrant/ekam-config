...
public class ConfigKeys {
  ...
  public static class Web {
    ...
    public static final String LOG_CONSOLE = "web.console.log";
  }
  ...
  public static class Log {
    public static final String LOG_TYPES = "log.types";
    public static final String LOG_PATTERN = "log.pattern";
    public static final String LOG_LEVEL = "log.level";
    public static final String LOG_FILE_MAX_SIZE = "log.MaxFileSize";
    public static final String CONSOLE_LOG_LEVEL = "log.console.level";
    public static final String FILE_LOG_LEVEL = "log.file.level";
    public static final String FILE_LOG_PATTERN = "log.file.pattern";
    public static final String CONSOLE_LOG_PATTERN = "log.console.pattern";
  }
}
